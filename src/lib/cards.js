...
const questions = [
  "Una cena con mi culito estaria incompleta sin _____.",
  ...
  "Tengo 99 peos encima pero _____ no es uno de ellos.",
  "Aprendi a los coñasos que no puedo animar a un amigo de luto con _____.",
  "No soy como el resto de ustedes, tengo demasiada plata y vainas que hacer como para _____.",
  "Coye profe no pude hacer la tarea porque _____.",
  "In 1,000 years when paper money is but a distant memory, _____ will be our currency.",
  "En Tocoron, puedes darle 500 lucas al pran por _____.",
  ...
  "Jesus is _____.",
  "La vida de los guajiros cambio para siempre cuando Cristobal Colon les mostro _____.",
  ...
  "Esa la verga que tiene la chama es de nacimiento, debe ser _____.",
  "Los sifrinos del country club estan pagando un rialero solo para probar _____.",
  ...
  "Mi mama se volvio loca cuando vio mi historial de navegacion y encontro _____.com.",
